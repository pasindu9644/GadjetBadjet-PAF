...
public class ServiceProduct {
	...
	public String insertProduct(@FormParam("pName") String pName, 
		...
		String output = ProductObj.insertProduct(pName, pDate, pPrice, rname);
		return output;
	...
	public String updateProduct(String productData) {
		...
		String rname = ProObject.get("rname").getAsString();

		String output = ProductObj.updateProduct(pId, pName, pDate, pPrice, rname);
		return output;
	}
